<<<<<<< Updated upstream:indexSupervisor.php
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<div class="col-sm-12" style="padding:20px">
  <button type="submit" onclick="window.location='./bandejaSupervisor.php'" class="btn btn-success btn-lg btn-block">Gestionar Excepciones</button>
      ...
      <div class="row well-2" align="right" style="padding-right:17px; margin-left:-20px; margin-right: -20px; height:100px; border-bottom-right-radius:4px;border-bottom-left-radius:4px;">
        <br>
        <button type="submit" style="margin-top:5px" onclick="window.top.close();" class="btn btn-danger btn-lg">Cerrar sesión <span class="glyphicon glyphicon-remove"></span></button>
      </div>
    </div>
  </div>
